...
-Click on Register Lecturer and input lecturer username , First name, Surname and Password
-Click on Login Lecturer  and input lecturer username and passsword to access the lecturer homepage
...
Student Features-
-Click on Register Student and input student username , First name, Surname and Password
-Click on Login Student and input student username and passsword to access the lecturer homepage
